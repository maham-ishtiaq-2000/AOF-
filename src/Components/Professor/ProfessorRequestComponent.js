...
export default function ProfessorRequestComponent(props) {
    ...
    const { _id, name, nameAr, country, university, college, major, reason, searchText, searchedColumn } = FormData;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record) => <Space size="middle">
                ...
                <Modal okText="Approve" title="Professor Details" visible={isReviewModalVisible} onOk={(e) => { handleReviewOk(_id) }} onCancel={(e) => { handleReviewCancel(record) }}>

                    <div className="row">
                        <div className="col-6">
                            <p><strong>Professor Name EN</strong></p>
                            <p><strong>Professor Name AR</strong></p>
                ...
                <Modal okText="Update" title="Professor Details" visible={isModalVisible} onOk={(e) => { handleOk(_id) }} onCancel={(e) => { handleCancel(record) }}>
                    ...
                    <label for="nameEN" className="font-weight-bold">Professor Name EN</label>
                    <input className="col-12 rounded-0 p-3 bordercolor" id="#nameEN"
                        value={name}
                        name="name"
                        onChange={onHandleChange} />

                    <label for="nameEN" className="font-weight-bold">Professor Name AR</label>
                    <input className="col-12 rounded-0 p-3 bordercolor" id="#nameEN"
                        value={nameAr}
                        name="nameAr"
                        onChange={onHandleChange} />
