...
export default function MajorRequestComponent(props) {
    ...
    const { _id, name, nameAr, country, university, college, reason, searchedColumn, searchText } = FormData;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record) => <Space size="middle">
                ...
                <Modal okText="Approve" title="Major Details" visible={isReviewModalVisible} onOk={(e) => { handleReviewOk(_id) }} onCancel={(e) => { handleReviewCancel(record) }}>

                    <div className="row">
                        <div className="col-6">
                            <p><strong>Major Name EN</strong></p>
                            <p><strong>Major Name AR</strong></p>
                ...
                <Modal okText="Update" title="Major Details" visible={isModalVisible} onOk={(e) => { handleOk(_id) }} onCancel={(e) => { handleCancel(record) }}>

                    <label for="nameEN" className="font-weight-bold">Major Name EN</label>
                    <input className="col-12 rounded-0 p-3 bordercolor" id="#nameEN"
                        value={name}
                        name="name"
                        onChange={onHandleChange} />

                    <label for="nameEN" className="pt-2 font-weight-bold">Major Name AR</label>
                    <input className="col-12 rounded-0 p-3 bordercolor" id="#nameEN"
                        value={nameAr}
                        name="nameAr"
                        onChange={onHandleChange} />
