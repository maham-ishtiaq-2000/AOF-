...
export default function ServicesRequestComponent(props) {
    ...
    const { _id, name, price, country, university, college, subject, postKind, contactMethod, contact, feature, reason } = FormData;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record) => <Space size="middle">
                ...
                <Modal okText="Approve" title="Service Request Details" visible={isReviewModalVisible} onOk={(e) => { handleReviewOk(_id) }} onCancel={(e) => { handleReviewCancel(record) }}>
