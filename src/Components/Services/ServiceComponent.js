...
export default function ServiceComponent(props) {
    ...
    const { _id, name, price, postKind, contactMethod, contact, feature, searchText, searchedColumn } = FormData;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => <Space size="middle">
                ...
                <Modal okText="Update" title="Service Details" visible={isModalVisible} onOk={(e) => { handleOk(_id) }} onCancel={(e) => { handleCancel(record) }}>

                    <label for="pro" className="font-weight-bold">Service Name</label>
